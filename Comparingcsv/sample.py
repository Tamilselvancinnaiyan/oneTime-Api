...
# Usage example
file1_path = 'annual-enterprise-survey-2021-financial-year-provisional-csv (1).csv'
#file2_path = 'annual-enterprise-survey-2021-financial-year-provisional-csv.csv'
file2_path = 'Model.csv'
...
def check_matching():
    are_matching = True  # Replace with your actual boolean variable
